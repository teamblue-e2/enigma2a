...
def setBoxInfoItems():
	...
	BoxInfo.setItem("PowerLED", fileCheck("/proc/stb/power/powerled") or model in ("gbue4k", "gbquad4k", "gbtrio4k", "gbquad4kpro") and fileCheck("/proc/stb/fp/led1_pattern"))
	BoxInfo.setItem("StandbyLED", fileCheck("/proc/stb/power/standbyled") or model in ("gbue4k", "gbquad4k", "gbquad4kpro", "gbtrio4k") and fileCheck("/proc/stb/fp/led0_pattern"))
	...
	BoxInfo.setItem("HasFrontDisplayPicon", model in ("et8500", "vusolo4k", "vuuno4kse", "vuduo4k", "vuduo4kse", "vuultimo4k", "gbquad4kpro", "gbquad4k", "gbue4k"))
